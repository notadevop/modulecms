...
define('USERNOTFOUND',		'Указанный пользователь удален/заблокирован или не сушествует!');
define('USERBANNED', 		'Указанный пользователь отправлен в бан или удален!');
define('USERNOTCONFREG', 	'Пользователь не подтвердил свою регистрацию!');
define('NOLISTUSERS', 		'Не могу вывести список пользователей!');
define('USERNULL',			'Некорректный или отсутствует ID пользователя!');
define('USERNOTCOMPLETE', 	'Ваш профиль не до конца заполнен!');
