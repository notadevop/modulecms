	...
	<div class="col-md-7 col-lg-5">
		<div class="login-wrap p-4 p-md-5">
			...
			<form action="<?=$this->allRoutes['/login']['url'];?>" method="post" class="login-form">
		        ...
		        <div class="form-group">
		        	<input class="form-control btn btn-primary rounded submit px-3" type="submit" name="<?=Identificator::LOGINBKEY;?>" value="<?=FORMLOGINBUTTON;?>">
		        </div>
				...
				<div class="form-check">
				  ...
				  <label class="form-check-label" for="flexCheckDefault"><?=FORMALIENPCTITLE;?></label>
				</div>
